...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."_locales" AS ENUM('fa');
  ...
  CREATE TABLE "products" (
  	...
  	"attributes_material" varchar,
  	"attributes_capacity_ml" numeric,
  	"attributes_pack_size" varchar,
  	"attributes_heat_resistance_c" numeric,
  	"b2b_wholesale_price" numeric,
  	"b2b_moq" numeric,
  	"b2b_b2b_only" boolean DEFAULT false,
  	"seo_title" varchar,
  	"seo_description" varchar,
  	"seo_focus_keyword" varchar,
  	"legacy_id" numeric,
  ...
  CREATE INDEX "products_legacy_id_idx" ON "products" USING btree ("legacy_id");
